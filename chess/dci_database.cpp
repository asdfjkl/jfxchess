...
int chess::DCIDatabase::loadIndex(QString &filename, QWidget* parent) {
...
int chess::DCIDatabase::loadMetaData(QString &filename,
...
int chess::DCIDatabase::countGames() {
    return this->indices->length();
}

chess::Game* chess::DCIDatabase::getGameFromEntry(chess::IndexEntry *ie) {
...
chess::Game* chess::DCIDatabase::getGameAt(int i) {
...
void chess::DCIDatabase::importPgnAndSave(QString &pgnfile) {
...
void chess::DCIDatabase::importPgnNamesSitesEvents(QString &pgnfile,
...
void chess::DCIDatabase::importPgnAppendNames(QMap<QString, quint32> *names) {
...
// save the map at the _end_ of file with filename (i.e. apend new names or sites)
// update the offset while saving
void chess::DCIDatabase::importPgnAppendEvents(QMap<QString, quint32> *events) {
...
void chess::DCIDatabase::importPgnAppendGamesIndices(QString &pgnfile,
                                                  QMap<QString, quint32> *names,
                                                  QMap<QString, quint32> *sites,
                                                  QMap<QString, quint32> *events) {
