...
REM copy output
copy target\jerryfx-4.1-jar-with-dependencies.jar "C:\Users\user\MyFiles\workspace\build dir\jar"
cd "C:\Users\user\MyFiles\workspace\build dir"
jpackage --java-options '-splash:$APPDIR/splash.png' --type app-image -n jerryfx -i jar --main-jar jerryfx-4.1-jar-with-dependencies.jar -d output --icon jerry.ico
