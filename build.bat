...
cd "C:\MyFiles\workspace\build dir"
jpackage --module-path javafx-mods  --add-modules javafx.controls,javafx.swing --java-options '-splash:$APPDIR/splash.png' --type app-image -n jfxchess -i jar --main-jar jfxchess-4.5-jar-with-dependencies.jar -d output --icon jfxchess.ico
