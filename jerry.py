...
class MainWindow(QMainWindow):
    def __init__(self):
        ...
        load_game = m_database.addAction(self.trUtf8("Browse..."))
        load_game.setShortcut('L')
        load_game.triggered.connect(partial(file_io.browse_database, self))
        m_database.addSeparator()
        next_ = m_database.addAction(self.trUtf8("Next in Database"))
        prev_ = m_database.addAction(self.trUtf8("Previous in Database"))
