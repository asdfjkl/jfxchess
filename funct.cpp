...
void FuncT::run_pgnt() {
    ...
    QString c2 = QString("C://Users//user//MyFiles//workspace//jerry//data/complex2.pgn");
    QString c3 = QString("C://Users//user//MyFiles//workspace//jerry//data/complex3.pgn");
    this->rwrw_pgn(c1,c2);
    this->rwrw_pgn(c2,c3);

    std::cout << "reading simple.pgn..." << std::endl;
    QString s1 = QString("C://Users//user//MyFiles//workspace//jerry//data/simple.pgn");
    QString s2 = QString("C://Users//user//MyFiles//workspace//jerry//data/simple2.pgn");
    QString s3 = QString("C://Users//user//MyFiles//workspace//jerry//data/simple3.pgn");
    this->rwrw_pgn(s1,s2);
    this->rwrw_pgn(s2,s3);


    std::cout << "reading nakamura_rybka_ascii_linux.pgn..." << std::endl;
    QString nr1 = QString("C://Users//user//MyFiles//workspace//jerry//data/nakamura_rybka_ascii_linux.pgn");
    QString nr2 = QString("C://Users//user//MyFiles//workspace//jerry//data/nakamura_rybka_ascii_linux1.pgn");
    QString nr3 = QString("C://Users//user//MyFiles//workspace//jerry//data/nakamura_rybka_ascii_linux2.pgn");
    this->rwrw_pgn(nr1,nr2);
    this->rwrw_pgn(nr2,nr3);

    std::cout << "reading nak. ryb ascii winline.pgn..." << std::endl;
    QString nr_a1 = QString("C://Users//user//MyFiles//workspace//jerry//data/nakamura_rybka_ascii_winline.pgn");
    QString nr_a2 = QString("C://Users//user//MyFiles//workspace//jerry//data/nakamura_rybka_ascii_winline1.pgn");
    QString nr_a3 = QString("C://Users//user//MyFiles//workspace//jerry//data/nakamura_rybka_ascii_winline2.pgn");
    this->rwrw_pgn(nr_a1,nr_a2);
    this->rwrw_pgn(nr_a2,nr_a3);

    std::cout << "reading nakamura rybka.pgn..." << std::endl;
    QString nr_b1 = QString("C://Users//user//MyFiles//workspace//jerry//data/nakamura_rybka.pgn");
    QString nr_b2 = QString("C://Users//user//MyFiles//workspace//jerry//data/nakamura_rybka1.pgn");
    QString nr_b3 = QString("C://Users//user//MyFiles//workspace//jerry//data/nakamura_rybka2.pgn");
    this->rwrw_pgn(nr_b1,nr_b2);
    this->rwrw_pgn(nr_b2,nr_b3);

    std::cout << "reading kasp deep blue.pgn..." << std::endl;
    QString k1 = QString("C://Users//user//MyFiles//workspace//jerry//data/kasparov-deep-blue-1997.pgn");
    QString k2 = QString("C://Users//user//MyFiles//workspace//jerry//data/kasparov-deep-blue-19971.pgn");
    QString k3 = QString("C://Users//user//MyFiles//workspace//jerry//data/kasparov-deep-blue-19972.pgn");
    this->rwrw_pgn(k1,k2);
    this->rwrw_pgn(k2,k3);

    std::cout << "reading lichess_test.pgn..." << std::endl;
    QString l1 = QString("C://Users//user//MyFiles//workspace//jerry//data/lichess_test.pgn");
    QString l2 = QString("C://Users//user//MyFiles//workspace//jerry//data/lichess_test1.pgn");
